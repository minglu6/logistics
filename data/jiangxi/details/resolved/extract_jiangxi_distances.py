...
# -*- coding: utf-8 -*-
"""
从江西7月、8月、9月、10月、11月、12月对账单中提取距离数据
...
# 定义月份文件（按时间顺序）
month_files = [
    ('7月', r'D:\Work\logistics\data\jiangxi\summary\2025\惠宜选江西仓7月1号至7月31号对账单 .xlsx'),
    ('8月', r'D:\Work\logistics\data\jiangxi\summary\2025\惠宜选江西仓8月份对账单.xlsx'),
    ('9月', r'D:\Work\logistics\data\jiangxi\summary\2025\最新惠宜选江西仓9月份对账单完整版.xlsx'),
    ('10月', r'D:\Work\logistics\data\jiangxi\summary\2025\惠宜选江西仓10月份对账单(2)(2).xlsx'),
    ('11月', r'D:\Work\logistics\data\jiangxi\summary\2025\惠宜选江西仓11月份对账单.xlsx'),
    ('12月', r'D:\Work\logistics\data\jiangxi\summary\2025\惠宜选江西仓12月份对账单.xlsx'),
]
...
# 保存主JSON文件
output_file = r'D:\Work\logistics\data\jiangxi\cache\reusable_distances.json'
...
if large_differences:
    large_diff_output = r'D:\Work\logistics\data\jiangxi\cache\large_distance_differences.json'
    large_diff_data = []
...
print("数据来源统计")
print("="*100)
for month_name in ['7月', '8月', '9月', '10月', '11月', '12月']:
...
if large_differences:
    ...
    print("="*100)
    for d in large_differences[:10]:  # 只显示前10个
        print(f"\n路段: {d['segment']}")
