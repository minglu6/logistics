...
# 配置路径
EXCEL_PATH = 'data/hefei/summary/2026/惠宜选合肥仓1月份对账单0119.xlsx'
JSON_PATH = 'data/hefei/cache/reusable_distances.json'
OUTPUT_PATH = 'data/hefei/summary/2026/惠宜选合肥仓1月份对账单0119.xlsx'
...
def main():
    print("=" * 60)
    print("合肥仓1月对账单距离填充 (0113-0119数据)")
    print("=" * 60)
    ...
    for row_idx in range(2, ws.max_row + 1):
        ...
        if re.search(r'-\d+(\.\d+)?km', first_line) or re.search(r'-\?km', first_line):
            # print(f"第{row_idx}行: 已包含距离信息，跳过")
            continue
