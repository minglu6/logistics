...
# -*- coding: utf-8 -*-
"""
从合肥1月份对账单0112中提取距离数据，并合并到现有缓存中
...
print("=" * 80)
print("从合肥对账单0112提取距离数据并更新缓存")
print("=" * 80)

# 文件路径
excel_file = 'data/hefei/summary/2026/惠宜选合肥仓1月份对账单0112.xlsx'
cache_file = 'data/hefei/cache/reusable_distances.json'
large_diff_file = 'data/hefei/cache/large_distance_differences.json'
